...
2. Review-fix-loop with native gates. Run review-repair-checks plus atomic packaging to green. Bound it: max 3 fix cycles per unit, then stop as blocked/non-converged. Never widen scope to unrelated code.
