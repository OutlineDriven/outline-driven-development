...
description: 'Use when a user says a site or app is ready to ship and wants a decision-gated pre-launch readiness pass. Not for deployment execution: use shipping.'
