...
Load this only when the user asks for the full write-up (SKILL.md stage 5). The default deliverable is the compact chat verdict; this is the opt-in expanded artifact for reading, sharing, or handing to the next skill.

## What it contains

The verdict, expanded. Lead with the decision, then the evidence the chat verdict omitted:
...
- Reversal trigger (Tier 2/3 only): what would flip this verdict.
