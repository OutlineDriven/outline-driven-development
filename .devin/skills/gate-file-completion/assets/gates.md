...
Three templates in one file: the plan contract (orchestrated mode), leaf gates, and branch/integration gates. Format spec and writing guide: the gate-format section in `../SKILL.md`.
...
Branch gates exist because finished parts do not imply a finished whole. Do not mark N1 by trusting child reports: re-run every child gate and record the fresh output in N1's EVIDENCE field.
